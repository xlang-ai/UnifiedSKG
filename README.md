...
- [UnifiedSKG: A Unified Framework and Analysis for **S**tructured **K**nowledge **G**rounding](#unifiedskg--a-unified-framework-and-analysis-for---s--tructured---k--nowledge-grounding)
  ...
  * [To run](#to-run)
    ...
    + [Training](#training)
    + [Deepspeed](#deepspeed)
    + [With [wandb](https://wandb.ai/) report](#with--wandb--https---wandbai---report)
  * [Introduction of each file](#introduction-of-each-file)
    + [[configure](https://github.com/HKUNLP/UnifiedSKG/tree/master/configure)](#-configure--https---githubcom-hkunlp-unifiedskg-tree-master-configure-)
    + [[metrics](https://github.com/HKUNLP/UnifiedSKG/tree/master/metrics)](#-metrics--https---githubcom-hkunlp-unifiedskg-tree-master-metrics-)
    + [[models](https://github.com/HKUNLP/UnifiedSKG/tree/master/models)](#-models--https---githubcom-hkunlp-unifiedskg-tree-master-models-)
    + [[seq2seq_construction](https://github.com/HKUNLP/UnifiedSKG/tree/master/seq2seq_construction)](#-seq2seq-construction--https---githubcom-hkunlp-unifiedskg-tree-master-seq2seq-construction-)
    + [[third_party](https://github.com/HKUNLP/UnifiedSKG/tree/master/third_party)](#-third-party--https---githubcom-hkunlp-unifiedskg-tree-master-third-party-)
    + [[utils](https://github.com/HKUNLP/UnifiedSKG/tree/master/utils)](#-utils--https---githubcom-hkunlp-unifiedskg-tree-master-utils-)
    + [train.py](#trainpy)
    + [Procedure](#procedure)
